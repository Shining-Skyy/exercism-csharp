...
Given a name and a number, your task is to produce a sentence using that name and that number as an [ordinal numeral](https://en.wikipedia.org/wiki/Ordinal_numeral). Yaʻqūb expects to use numbers from 1 up to 999.
