public class LineUpTests
{
    ...
    [Fact]
    public void Format_non_exceptional_ordinal_numeral_111()
    {
        string expected = "Knud, you are the 111th customer we serve today. Thank you!";
        Assert.Equal(expected, LineUp.Format("Knud", 111));
    }
    ...
    [Fact]
    public void Format_non_exceptional_ordinal_numeral_113()
    {
        string expected = "Knud, you are the 113th customer we serve today. Thank you!";
        Assert.Equal(expected, LineUp.Format("Knud", 113));
    }
